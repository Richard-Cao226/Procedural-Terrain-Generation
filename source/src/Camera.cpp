...
void Camera::MouseLook(int mouseX, int mouseY){
    ...
    // the last time
    // TODO
    glm::vec2 deltaMouse = m_oldMousePosition - newMousePosition;
    float sensitivity = 0.01f;
    float deltaX = deltaMouse.x * sensitivity;

    // Rotate about the upVector
    // TODO
    m_viewDirection = glm::normalize(glm::rotate(m_viewDirection, deltaX, m_upVector));
